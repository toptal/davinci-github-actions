...
const file_command_1 = __nccwpck_require__(188);
const utils_1 = __nccwpck_require__(837);
const os = __importStar(__nccwpck_require__(37));
...
const http_client_1 = __nccwpck_require__(348);
const auth_1 = __nccwpck_require__(742);
const core_1 = __nccwpck_require__(951);
class OidcClient {
...
const pm = __nccwpck_require__(78);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
const parse = __nccwpck_require__(316);
const enoent = __nccwpck_require__(617);
...
const resolveCommand = __nccwpck_require__(423);
const escape = __nccwpck_require__(327);
const readShebang = __nccwpck_require__(465);
...
const shebangCommand = __nccwpck_require__(580);
...
const path = __nccwpck_require__(17);
const which = __nccwpck_require__(526);
const getPathKey = __nccwpck_require__(667);
...
const bufferStream = __nccwpck_require__(688);
...
if (process.platform === 'win32' || global.TESTING_WINDOWS) {
  core = __nccwpck_require__(874)
} else {
  core = __nccwpck_require__(779)
}
...
const shebangRegex = __nccwpck_require__(279);
...
if (!processOk(process)) {
  ...
  var signals = __nccwpck_require__(776)
...
module.exports = __nccwpck_require__(863);
...
const isexe = __nccwpck_require__(362)
...
var cross_spawn = __nccwpck_require__(379);
...
var signal_exit = __nccwpck_require__(637);
...
var get_stream = __nccwpck_require__(191);
// EXTERNAL MODULE: ./node_modules/merge-stream/index.js
var merge_stream = __nccwpck_require__(315);
...
(() => {
const core = __nccwpck_require__(951)
const execa = (__nccwpck_require__(261)/* .execa */ .r)
